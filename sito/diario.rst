...
|
  ...
  .. table::
    ...
    +-------+------------+----------------------------------------------------------------+---------------------------------------------------------------------+
    | 24    | Mar 27/5   | Generazione di codice (con l'*IR* di *LLVM*)                   | ICD 6.1-6; H24_                                                     |
    +-------+------------+----------------------------------------------------------------+---------------------------------------------------------------------+
...
.. _H24: https://github.com/let-unimi/handouts/blob/2318c6bf1b96dd6ddb6c0bf5a734195a2a6a31aa/L24.ipynb
